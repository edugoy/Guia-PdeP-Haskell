--2) Durante un entrenamiento físico de una hora, cada 10 minutos de entrenamiento se tomóo la frecuencia cardíaca de uno de 
...
--a)
--Funcion constante de frecuencia Cardiaca
...
frecuenciaCardiacaMinuto m = frecuenciaCardiaca !! (m `div` 10)

--c)
frecuenciasHastaMomento :: Int -> [Int]
frecuenciasHastaMomento m = take ((m `div` 10) + 1) frecuenciaCardiaca